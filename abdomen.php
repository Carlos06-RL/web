...
<head>
  <meta charset="UTF-8">
  <title>Ejercicios para Abdomen</title>
...
<body>
  ...
  <div class="embed-3d"> 
    <iframe 
      title="Thorax and abdomen, a few important muscles" 
      frameborder="0" 
      allowfullscreen 
  ...
  <div class="container">
    <h2 style="text-align:center; margin-bottom:1em;">Aprende cómo entrenar abdomen con estos ejercicios</h2>

    <?php
    // musculo_id = 3 → abdomen
    $result = $conn->query("SELECT nombre, descripcion, video_url FROM ejercicios WHERE musculo_id = 3");
    ...
    <div class="pagination">
      <a href="#">&laquo;</a>
      <a href="abdomen.php" class="active">1</a>
      <a href="abdomen2.php">2</a>
      <a href="abdomen3.php">3</a>
      <a href="#">&raquo;</a>
    </div>
