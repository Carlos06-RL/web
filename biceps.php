...
<head>
  <meta charset="UTF-8">
  <title>Ejercicios para Bíceps</title>
...
<body>
  ...
  <div class="container">
    <h2 style="text-align:center; margin-bottom:1em;">Aprende cómo entrenar bíceps con estos ejercicios</h2>

    <?php
    // musculo_id = 1 → bíceps
    $result = $conn->query("SELECT nombre, descripcion, video_url FROM ejercicios WHERE musculo_id = 1");
    ...
    <div class="pagination">
      <a href="#">&laquo;</a>
      <a href="biceps.php" class="active">1</a>
      <a href="biceps2.php">2</a>
      <a href="biceps3.php">3</a>
      <a href="#">&raquo;</a>
    </div>
